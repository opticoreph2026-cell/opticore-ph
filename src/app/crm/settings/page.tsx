  ...
  return (
    <div className="flex items-center justify-center h-96">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-xl font-semibold text-white/40">System Settings</h2>
        <p className="text-sm text-white/20 max-w-md">
          CRM configuration, lead routing rules, and automation settings will be available here.
        </p>
        <Link
          href="/crm"
