      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full bg-[#0F0F14] border border-white/5 rounded-lg px-3 py-2 text-sm text-white placeholder-white/20 focus:outline-none focus:border-accent-amber/50 focus:ring-1 focus:ring-accent-amber/50"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full bg-[#0F0F14] border border-white/5 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-accent-amber/50 focus:ring-1 focus:ring-accent-amber/50"
              >
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full bg-[#0F0F14] border border-white/5 rounded-lg px-3 py-2 text-sm text-white placeholder-white/20 focus:outline-none focus:border-accent-amber/50 focus:ring-1 focus:ring-accent-amber/50 resize-none"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg bg-accent-amber text-[#08080B] text-sm font-semibold hover:bg-accent-amber/90 transition-colors disabled:opacity-50"
          >
