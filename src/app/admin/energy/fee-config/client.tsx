...
export function FeeConfigClient({ config }: { config: FeeConfig }) {
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-background-200 border border-foreground-950/10 rounded-lg px-4 py-2.5 text-foreground-950 focus:outline-none focus:ring-2 focus:ring-accent-cyan"
        />
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-background-200 border border-foreground-950/5 rounded-xl p-5">
