  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground-950 mb-2">Energy Catalog</h1>
          <p className="text-foreground-950/40">Manage components: Inverters, Batteries, and Solar Panels.</p>
        </div>
      </div>
