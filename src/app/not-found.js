...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-surface-950 flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      {/* Radar Pulse Effect */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
        <div className="w-[300px] h-[300px] border border-brand-500/10 rounded-full animate-[ping_3s_linear_infinite]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border border-brand-500/5 rounded-full animate-[ping_3s_linear_infinite] [animation-delay:700ms]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] border border-brand-500/5 rounded-full animate-[ping_3s_linear_infinite] [animation-delay:1000ms]" />
      </div>

      <div className="relative z-10 animate-fade-up">
        <div className="relative mb-12">
          <div className="absolute inset-0 bg-brand-500/20 blur-3xl rounded-full scale-150" />
          <div className="relative w-24 h-24 rounded-full bg-surface-900 border border-white/10 flex items-center justify-center shadow-2xl mx-auto">
            {/* Custom 6s spin using Tailwind arbitrary value */}
            <Radar className="w-12 h-12 text-brand-400 animate-[spin_6s_linear_infinite]" />
          </div>
        </div>
        ...
        <p className="text-text-secondary max-w-sm mx-auto mb-12 text-lg leading-relaxed">
