  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400">Your signed contracts, invoices, certificates, and system diagrams.</p>
      </div>
              ...
              {docs.map((doc: any) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <FileText className={`w-5 h-5 ${docTypeIcons[docType] || 'text-gray-500'} flex-shrink-0`} />
                    <div>
