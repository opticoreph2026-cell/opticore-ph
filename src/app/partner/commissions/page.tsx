...
export default async function PartnerCommissionsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-display font-bold text-foreground-950 mb-2">Commissions & Payouts</h1>
        <p className="text-foreground-950/40">Track your earnings from referred installations.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-background-200 p-6 rounded-2xl border border-foreground-950/10">
      ...
      <div className="bg-background-200 border border-foreground-950/10 rounded-xl overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-foreground-950/70">
            <thead className="bg-background-100 text-xs uppercase text-foreground-950/40">
              <tr>
