...
export default async function PartnerCommissionsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Commissions & Payouts</h1>
        <p className="text-gray-400">Track your earnings from referred installations.</p>
      </div>
              ...
              {commissions.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center text-gray-500">
                    ...
                    <p className="text-xs text-gray-600 mt-1">Commissions will appear when projects are completed.</p>
                  </td>
                </tr>
              ) : (
