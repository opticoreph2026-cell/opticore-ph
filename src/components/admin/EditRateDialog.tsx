  ...
  return (
    <>
      <button
        ...
        className="p-1.5 rounded-lg text-foreground-950/40 hover:text-accent-cyan hover:bg-foreground-950/5 transition-colors"
        title="Edit rate"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-surface-900 border border-border-subtle rounded-2xl p-6 w-full max-w-md mx-4 shadow-2xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">All-in Rate (₱/kWh)</label>
                <input
                  type="number"
                  step="0.0001"
                  min="0"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">BGC Rate (₱/kWh)</label>
                <input
                  type="number"
                  step="0.0001"
                  min="0"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">Customer Class</label>
                <select
                  value={customerClass}
            ...
            <div className="flex items-center justify-end gap-3 mt-6">
              ...
              <button
                ...
                onClick={handleSave}
                disabled={loading}
                className="px-4 py-2 text-sm font-medium text-foreground-950 bg-accent-cyan rounded-xl hover:bg-accent-cyan/90 transition-colors disabled:opacity-50 flex items-center gap-2"
              >
