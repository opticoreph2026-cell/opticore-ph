        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-background-100 border border-foreground-950/10 rounded-2xl p-6 w-full max-w-lg mx-4 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">Category</label>
                <select
                  value={form.category}
              ...
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">Model Name *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">SKU *</label>
                <input
                  type="text"
                  required
                  value={form.sku}
              ...
              {form.category === 'inverter' && (
                <div>
                  <label className="block text-sm font-medium text-foreground-950/80 mb-1">Rated AC (kW)</label>
                  <input
                    type="number"
                    step="0.1"
              ...
              {form.category === 'battery' && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-foreground-950/80 mb-1">Nominal (kWh)</label>
                    <input
                      type="number"
                      step="0.1"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground-950/80 mb-1">Usable (kWh)</label>
                    <input
                      type="number"
                      step="0.1"
              ...
              {form.category === 'panel' && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-foreground-950/80 mb-1">Wattage (W)</label>
                    <input
                      type="number"
                      value={form.wattage}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground-950/80 mb-1">Efficiency (%)</label>
                    <input
                      type="number"
                      step="0.1"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground-950/80 mb-1">Price (₱)</label>
                <input
                  type="number"
                  step="0.01"
