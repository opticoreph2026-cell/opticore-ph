  ...
  return (
    <header className="h-20 px-6 lg:px-8 flex items-center justify-between gap-8 z-50 sticky top-0 bg-surface-1000/60 backdrop-blur-xl border-b border-white/[0.04]">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex items-center gap-3 px-4 py-2 rounded-xl bg-white/[0.03] border border-white/10 w-80 group focus-within:border-brand-500/50 transition-all">
