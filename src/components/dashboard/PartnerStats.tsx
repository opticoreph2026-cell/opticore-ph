  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="group bg-background-100 p-6 rounded-2xl border border-foreground-950/10 hover:border-foreground-950/20 hover:bg-background-200 transition-all duration-200">
