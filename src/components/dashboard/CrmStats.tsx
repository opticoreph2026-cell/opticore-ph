      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          ...
          <Link key={stat.label} href={stat.href}
            className="group bg-background-900 border border-foreground-950/10 rounded-2xl p-5 hover:border-foreground-950/20 hover:bg-background-800 transition-all duration-200"
          >
