    ...
    if (field.type === 'select' && field.options) {
      return (
        <select
          ...
          className="w-full bg-background-900 border border-foreground-950/10 rounded-lg px-3 py-2 text-sm text-foreground-950 focus:outline-none focus:ring-2 focus:ring-accent-cyan"
        >
    ...
    if (field.type === 'textarea') {
      return (
        <textarea
          ...
          rows={3}
          className="w-full bg-background-900 border border-foreground-950/10 rounded-lg px-3 py-2 text-sm text-foreground-950 focus:outline-none focus:ring-2 focus:ring-accent-cyan resize-none"
        />
      );
    }
